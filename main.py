# The optimal values of m and b can be actually calculated with
# way less effort than doing a linear regression.
...
def run():
    ...
    print("After {0} iterations b = {1}, m = {2}, error = {3}".format(
        num_iterations, b, m, compute_error_for_line_given_points(
            b, m, points)))
    return
